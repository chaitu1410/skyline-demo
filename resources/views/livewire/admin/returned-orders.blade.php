    ...
    <table class="table table-bordered">
        ...
        <tbody>
            @forelse ($returnorders as $returnorder )
                <tr wire:key="{{ $returnorder->id }}">
                    <td>{{ $returnorder->id }}</td>
                    <td>{{ $returnorder->order->id }}</td>
                    <td>{{ $returnorder->order->razorpayPaymentId }}</td>
                    <td>
                    ...
                    <div class="modal fade" id="reasonreturnmodalwithreply{{ $returnorder->id }}" tabindex="-1" aria-labelledby="replyreturnmodalLabel" aria-hidden="true">
                            ...
                            <form action="{{ route('admin.orders.returnReply', $returnorder->id) }}" method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        @forelse ($returnorder->returnOrderProducts as $p)  
                                            <div wire:key="prod{{ $p->id }}" class="returnedproduct">
                                                <div class="orderhistoryitem">
                                                    <p class="mb-0">
