  ...
  <div id="prodinfocontainer">
    ...
    <div class="prodinfocont">
      ...
      <div class="prodpricees">
        ...
        <p class="mb-1">Price: <span class="text-secondary">₹{{ $product->discountedPrice() }} (GST extra)</span></p>
        <p class="mb-1">Selling Price: <span class="text-success"><strong> ₹{{ $product->sellingPrice }}</strong></span> <span>(GST Inclusive Price)</span></p>
        <p class="mb-1">FREE Delivery: <strong class="text-dark">In 2-3 weeks</strong></p>
      </div>
      <hr>
    ...
    <div id="prodaddtocartboxcont">
      <a href="" class="shareprod">
        ...
        <svg id="whatsappshare" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          class="bi bi-whatsapp" viewBox="0 0 16 16" onclick="location.href='{{ route('products.show', $product) }}'">
          <path
        ...
        <svg id="mailshare" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          class="bi bi-envelope" viewBox="0 0 16 16" onclick="location.href='{{ route('products.show', $product) }}'">
          <path
        ...
        <svg id="instashare" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          class="bi bi-instagram" viewBox="0 0 16 16" onclick="location.href='{{ route('products.show', $product) }}'">
          <path
        ...
        <svg id="fbshare" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          class="bi bi-facebook" viewBox="0 0 16 16" onclick="location.href='{{ route('products.show', $product) }}'">
          <path
            d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
        </svg>
      </a>
      <div class="card p-2">
        <div id="bulkquotebtnincartbox" class="btn bg-orange border-light" onclick="location.href='{{ route('quotes.create') }}'">Request Quote</div>
  ...
  <div class="productscont">
    ...
    @forelse ($relatedProducts as $prod)
      <div class="procard card">
        ...
        <div class="productdetails" onclick="location.href='{{ route('products.show', $prod) }}'">
          <a href="{{ route('products.show', $prod) }}">
            <p class="prodname">{{ $prod->name }}</p>
          </a>
          <img src="{{ asset('images/'.$prod->brand->image) }}" alt="{{ $prod->brand->name }}">
          <p class="mb-0 text-success prodprice"><span class="cutprice text-danger">₹{{ $prod->mrp }} </span> ₹{{ $prod->discountedPrice() }}</p>
        </div>
      </div>
    @empty
